...
![Groups of birds on a telephone pole](/blog/2022/01/kubernetes-101/banner.jpg)
...
![Dashboard login](/blog/2022/01/kubernetes-101/dashboard-login.png)
...
![Dashboard home](/blog/2022/01/kubernetes-101/dashboard-home.png)
...
![Dashboard home with deployment](/blog/2022/01/kubernetes-101/dahsboard-home-with-deployment.png)
...
![Dashboard home: deployments and pods](/blog/2022/01/kubernetes-101/dashboard-home-deployments-and-pods.png)
...
![Dashboard pod exec](/blog/2022/01/kubernetes-101/dashboard-pod-exec.png)

Click it and you'll be taken to a screen with a console just like the one we obtained via `kubectl exec`:

![Dashboard pod bash](/blog/2022/01/kubernetes-101/dashboard-pod-bash.png)
...
![Dashboard: services](/blog/2022/01/kubernetes-101/dashboard-services.png)
...
![NGINX via Cluster IP](/blog/2022/01/kubernetes-101/nginx-via-cluster-ip.png)
...
![NGINX via NodePort](/blog/2022/01/kubernetes-101/nginx-via-nodeport.png)
...
![Dashboard DB deployment and pod](/blog/2022/01/kubernetes-101/dashboard-db-deployment-and-pod.png)
...
![Dashboard persistent volume](/blog/2022/01/kubernetes-101/dashboard-persistent-volume.png)
...
![Dashboard persistent volume claim](/blog/2022/01/kubernetes-101/dashboard-persistent-volume-claim.png)
...
![Swagger!](/blog/2022/01/kubernetes-101/swagger.png)
...
![SwaggerUI on prod](/blog/2022/01/kubernetes-101/swagger-prod.png)
